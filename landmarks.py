leftIrisLandmarks = frozenset([(474, 475), (475, 476), (476, 477),
                                (477, 474)])


rightIrisLandmarks = frozenset([(469, 470), (470, 471), (471, 472),
                                (472, 469)])

faceOvalLandmarks = frozenset([(10, 338), (338, 297), (297, 332), (332, 284),
...
irisesLandmarks = frozenset().union(*[leftIrisLandmarks, rightIrisLandmarks])

facemeshLandmarks = frozenset([
...
landmarks = frozenset().union(*[facemeshLandmarks])

lipsLandmarks = frozenset([
                    (61, 146), (146, 91), (91, 181), (181, 84), (84, 17),
                    (17, 314), (314, 405), (405, 321), (321, 375),
                    (375, 291), #lower outer lip line
                    (61, 185), (185, 40), (40, 39), (39, 37),
                    (37, 0), (0, 267), (267, 269), (269, 270), 
                    (270, 409), (409, 291), #upper outer lip line
                    (78, 95), (95, 88), (88, 178), (178, 87), (87, 14),
                    (14, 317), (317, 402), (402, 318), (318, 324), (324, 308), #lower inner lip line
                    (78, 191), (191, 80), (80, 81), (81, 82),
                    (82, 13), (13, 312), (312, 311), (311, 310),
                    (310, 415), (415, 308), # upper inner lip line #55

                    (164,393), (393,391), (391,322), (322,410),(410,287),
                    (287,273), (273,335), (335,406), (406,313), (313,18),
                    (18,83), (83,182),(182,106), (106,43), (43,57), (57,186),
                    (186,92), (92,165), (165,167), (167,164), # outer mouth #75

                    (164,0), (164,37), (37,165), (165,40), (40,186), (186,61), (61,57),
                    (164,267), (267,391), (391,270), (410,270), (410,291), (287,291), #index=88
                    
                    # right side
                    (18,17), (18,84), (84,182), (182,91), (91,43), (43,57),
                    # left side
                    (18,314), (314,406), (406,321), (273,321), (273,308),                

                    ])
    
mouthLandmarks = frozenset([
                # (13,317), (317,311), (311,311), (311,318), (318,415), 
                (13,317), (317,311), (311,318), (318,415),
                (13,87), (87,81), (81,88), (88,191),#vertical mouth
                # (61,291), #horizontal mouth

                ]) 

# browsLandmarks = frozenset([
#                     (9,285), (9,336), (9,8), (9,55), (9,107), (9,151), (9,108), (9,337),
#                     (8,55), (8,285), # brow centre

#                     (151,108), (108,69), (69,104),
#                     (66,105), (66,107),
#                     (296,336),(296,334),
#                     (151,337),(299,337),(298,333),(299,333),

#                     (336,337), (299,336), (296,299), (299,334), (333,334), (298,334),
#                     (285,336), (285,286), (336,258), (258,296), (296,257),(257,334),(334,259),(259,298), (298,263),

#                     (107,108), (69,107), (66,69), (69,105), (104,105), (68,105),
#                     (55,107),
#                     (27,29),(27,28),(28,56),
#                     (258,286),(257,258),(259,257),(68,104),
#                     (68,29), (68,33), (29,105), (105,27), (27,66), (66,28), (28,107), (55,56),
                    
#                     # below the left eye
#                     (263,372), (263,346), (373,346), (373,348), (380,348), (380,350), (362,350),
#                     # below the right eye
#                     (33,143), (33,117), (144,117), (144,119), (153,119), (153,121), (133,121),
...
browsLandmarks = frozenset([
                    ...
                    (151,108), (108,107), (107,55),
                    (151,337), (337,336), (336,285), # brow centre
                    
                    (108,69), (69,104),
                    (66,105), (66,107),
                    (296,336),(296,334),
                    (299,337),(298,333),(299,333), # upper browline

                    (299,336), (296,299), (299,334), (333,334), (298,334),
                    (285,336), (285,286), (336,258), (258,296), (296,257),(257,334),(334,259),(259,298), # rightbrow connections

                    (107,108), (69,107), (66,69), (69,105), (104,105), (68,105), (55,107), (68,104), 
                    (27,29),(27,28),(28,56),
                    (258,286),(257,258),(259,257),
                    (68,29), (29,105), (105,27), (27,66), (66,28), (28,107), (55,56), # leftbrow connections
...
leftEyebrowLandmarks = frozenset([(276, 283), (283, 282), (282, 295),
                                    (295, 285), #lower
                                    (300, 293), (293, 334),
                                    (334, 296), (296, 336)]) #upper index=7

rightEyebrowLandmarks = frozenset([(46, 53), (53, 52), (52, 65), (65, 55), #lower
                                    (70, 63), (63, 105), (105, 66), (66, 107)]) #upper index=15


leftEyeLandmarks = frozenset([(263, 373), (373,380), (380,362), #lower
                                (263, 387), (387,385), (385,362), #upper
                                (373,387), (380,385), (387,380),
                            ])

rightEyeLandmarks = frozenset([(33, 144), (144, 153), (153, 133), #lower
                                (33,160), (160,158), (158,133), #upper 
                                (144,160), (153,158), (153,160),
                                ])

contourLandmarks = frozenset().union(*[
    lipsLandmarks, leftEyeLandmarks, leftEyebrowLandmarks, rightEyeLandmarks,
    rightEyebrowLandmarks, faceOvalLandmarks
])

noseLandmarks = frozenset([
                            (2,4), (4,129), (4,358), (129,2), (358,2), 
                            (4,168), (168,129), (168,358),
                            # (168,8),
                            ])

cheeksLandmarks = frozenset([
                            (129,119), (119,187), (187,129),
                            (358,348), (348,411), (411,358),
                            ])

evaLandmarks = frozenset([
                            (168,55), (168,285),
                            ])

selectedLandmarks = frozenset().union(*[
...
faceOutlines = frozenset(
    [
        (149, 150), (150, 136), (136, 172), (172, 58), (58, 132), (132, 93), (93, 234), (234, 127), (127, 162), (162, 21), (21, 54), (54, 103), (103, 67), (67, 109), (109, 10), (10, 338), (338, 297), (297, 332), (332, 284), (284, 251), (251, 389), (389, 356), (356, 454), (454, 323), (323, 361), (361, 288), (288, 397), (397, 365), (365, 379), (379, 378), (378, 400), (400, 377), (377, 152), (152, 148), (148, 176), (176, 149), (149, 150),
     ]
)

faceOutlineArray = [
    152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109, 10,  # chin-left-top
    338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152] # top-right-chin

leftFaceOutlineArray = [
    152, 148, 176, 149, 150, 136, 172, 58, 132, 93, 234, 127, 162, 21, 54, 103, 67, 109, 10,  # chin-left-top
    338, 297, 332, 284, 298, 293, 276, 353, 265, 340, 352, 411, 434, 431, 369, 396, 152] # top-right-chin

rightFaceOutlineArray = [
    152, 171, 140, 211, 214, 187, 123, 111, 35, 156, 46, 63, 68, 54, 103, 67, 109, 10,  # chin-left-top
    338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379, 378, 400, 377, 152] # top-right-chin